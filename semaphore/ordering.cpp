...
#include <semaphore.h>
#include <stdio.h>
//yts:在mac os上无法按照预期执行，将USE_CPU_FENCE和USE_SINGLE_HW_THREAD设置为1仍旧会有reorder
//知识点：
//1.通过semaphore来控制线程间如何同步(这里是thread1, thread2和main)
//2.通过cpu fence来防止reorder
//3.通过绑定CPU来防止reorder
